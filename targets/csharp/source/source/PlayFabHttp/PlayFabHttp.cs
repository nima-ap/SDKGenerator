...
namespace PlayFab.Internal
{
    ...
    public static class PlayFabHttp
    {
        ...
        public static async Task<object> DebugDoPost(string fullUri, PlayFabRequestCommon request, string authType, string authKey, Dictionary<string, string> extraHeaders, PlayFabApiSettings apiSettings = null)
        {
